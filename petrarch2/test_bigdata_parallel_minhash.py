...
actorReolver = ActorResolver(clsSimilarity=MinhashClusterSimilarity())
...
output_dir = raw_input("Enter Input Directory")
if os.path.exists(output_dir) is False:
    os.mkdir(output_dir)
    print "Created Sccuessfully"
...
uf = compress(item_list=recommended_actors, simCalculator=MinhashClusterSimilarity())
